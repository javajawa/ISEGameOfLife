...
public class TestPoliticalAgent extends AbstractAgent
{
	...
	protected String chooseGroup()
	{
		...
		{
			logger.log(Level.INFO, "I, agent {0} with E belief: {1} and I belong to {2}", new Object[]
							{
								this.getDataModel().getName(), this.getDataModel().getEconomicBelief(), getConn().getGroupById(this.getDataModel().getGroupId()).getName()
							});
		}
...
//                return leaveGroup;
	...
	protected Food chooseFood()
	{
		...
		Food suggestedFood, cooperateFood, defectFood, choice;
                ...
                //Distinguish between stags (cooperation) and rabbits (defection)
