...
enum Statements
{
	...
	roundGroup("INSERT INTO g_data (simid,round,groupid,pop,socialPosition,economicPosition) VALUES (?,?,?,?,?,?);"),
	roundLoanGroup("INSERT INTO lg_data (simid,round,groupid,pop,socialPosition,economicPosition,reservedFood,happiness,totalgiven,totalborrowed) VALUES (?,?,?,?,?,?,?,?,?,?);"),
	roundAgent("INSERT INTO a_data (simid,round,agentid,groupid,foodAmount,lastHunted,"
	+ "socialBelief,economicBelief,happiness,loyalty)"
	+ " VALUES (?,?,?,?,?,?,?,?,?,?);"),
	trustAgent("INSERT INTO a_trust (simid,round,agentid,agentid_other,trust) VALUES (?,?,?,?,?);"),
